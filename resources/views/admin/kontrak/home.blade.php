                    ...
                    <tbody class="text-gray-700">
                        @foreach ($kontrak as $kontrak)
                            <tr class="border-b hover:bg-gray-100 transition duration-300">
                                ...
                                <td class="py-3 px-4 border-r border-gray-300">{{ \Carbon\Carbon::parse($kontrak->tanggal_mulai)->format('d M Y') }}</td>
                                <td class="py-3 px-4 border-r border-gray-300">{{ \Carbon\Carbon::parse($kontrak->tanggal_selesai)->format('d M Y') }}</td>
