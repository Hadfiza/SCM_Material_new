        ...
        <div class="container mx-auto py-12">
            ...
            <form action="{{ route('admin.order.update', $order->id) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" value="{{ $order->material_id }}" name="material_id"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                        value="{{ $order->id_material }}" required>
                </div>

                <div class="mb-4">
                    <label for="id_material" class="block text-gray-700 font-bold mb-2">ID Pengiriman:</label>
                    <input type="number" value="{{ $order->pengiriman_id }}" name="pengiriman_id"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                        value="{{ $order->id_material }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="jumlah_order"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="status_order"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                        value="{{ $order->status_order }}" required>
                </div>
                ...
                <button type="submit"
                    class="bg-blue-500 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">Simpan
                    Perubahan</button>
            </form>
        </div>
    </body>
