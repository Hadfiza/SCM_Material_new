    ...
    <div class="container mx-auto py-12">
        ...
        <form action="{{ route('admin.order.store') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="material_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" required>
            </div>

            <div class="mb-4">
                <label for="id_pengiriman" class="block text-gray-700 font-bold mb-2">ID Pengiriman:</label>
                <input type="number" id="id_pengiriman" name="pengiriman_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" required>
            </div>
